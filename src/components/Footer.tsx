        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6">
            <div className="text-center md:text-left w-full md:w-auto">
              ...
              <p className="text-xs sm:text-sm text-secondary">Free pickup • Instant payment • Best prices in Melbourne</p>
            </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 mb-8 sm:mb-12">
          ...
          <div>
            ...
            <p className="text-sm text-secondary mb-6 leading-relaxed max-w-xs">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-heading font-semibold text-base sm:text-lg mb-4 sm:mb-6 flex items-center gap-2">
              <span className="w-1 h-6 bg-secondary rounded-full"></span>
              Quick Links
            </h4>
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link to="/" className="text-sm text-secondary hover:text-primary-foreground transition-all inline-flex items-center gap-2 group focus-ring rounded px-2 sm:px-0 -mx-2 sm:mx-0">
                  <span className="text-primary-foreground opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  Home
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-sm text-secondary hover:text-primary-foreground transition-all inline-flex items-center gap-2 group focus-ring rounded px-2 sm:px-0 -mx-2 sm:mx-0">
                  <span className="text-primary-foreground opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/services" className="text-sm text-secondary hover:text-primary-foreground transition-all inline-flex items-center gap-2 group focus-ring rounded px-2 sm:px-0 -mx-2 sm:mx-0">
                  <span className="text-primary-foreground opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  Our Services
                </Link>
              </li>
              <li>
                <Link to="/scrap-metal-prices-melbourne" className="text-sm text-secondary hover:text-primary-foreground transition-all inline-flex items-center gap-2 group focus-ring rounded px-2 sm:px-0 -mx-2 sm:mx-0">
                  <span className="text-primary-foreground opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  Scrap Metal Prices
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-sm text-secondary hover:text-primary-foreground transition-all inline-flex items-center gap-2 group focus-ring rounded px-2 sm:px-0 -mx-2 sm:mx-0">
                  <span className="text-primary-foreground opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  Contact Us
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li className="flex items-start gap-3 text-sm text-secondary group">
                ...
                <div className="text-left">
                  <p className="font-semibold mb-1 text-primary-foreground">Location</p>
              ...
              <li className="flex items-start gap-3 text-sm text-secondary group">
                ...
                <div className="text-left">
                  <p className="font-semibold mb-1 text-primary-foreground">Phone</p>
                  <a href="tel:+61452367372" className="hover:text-primary-foreground transition-colors focus-ring rounded px-1">
                    +61 452 367 372
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3 text-sm text-secondary group">
                ...
                <div className="text-left">
                  <p className="font-semibold mb-1 text-primary-foreground">Business Hours</p>
                  <div className="text-xs leading-relaxed">
                    <p>Monday to Friday: 7 AM – 5 PM</p>
              ...
              <li className="flex items-start gap-3 text-sm text-secondary group">
                ...
                <div className="text-left max-w-full">
                  <p className="font-semibold mb-1 text-primary-foreground">Email</p>
                  <a href="mailto:Operacr86@gmail.com" className="hover:text-primary-foreground transition-colors break-all focus-ring rounded px-1">
                    Operacr86@gmail.com
                  </a>
                </div>
              </li>
        ...
        <div className="border-t border-primary-foreground/20 mt-8 sm:mt-12 pt-6 sm:pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 text-xs">
              <Link to="/contact" className="text-secondary hover:text-primary-foreground transition-colors focus-ring rounded px-2 py-1 min-h-[44px] sm:min-h-0 flex items-center">Privacy Policy</Link>
              <span className="hidden sm:inline text-secondary">•</span>
              <Link to="/contact" className="text-secondary hover:text-primary-foreground transition-colors focus-ring rounded px-2 py-1 min-h-[44px] sm:min-h-0 flex items-center">Terms of Service</Link>
              <span className="hidden sm:inline text-secondary">•</span>
